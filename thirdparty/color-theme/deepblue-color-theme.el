...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "#102e4e" :foreground "#eeeeee" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "apple" :family "Monaco"))))
     ...
     (mode-line ((t (:bold t :background "mistyRose" :foreground "navy" :box (:line-width 1 :style released-button) :underline t :weight bold))))
     ...
     (show-paren-match ((t (:bold t :foreground "yellow" :weight bold))))
     (show-paren-match-face ((t (:bold t :foreground "yellow" :weight bold))))
     (show-paren-mismatch ((t (:bold t :foreground "red" :weight bold))))
