...
(defun my-color-theme ()
  "Color theme by minsky, created 2014-06-10."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "black" :foreground "#c0c0c0" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :foundry "default" :family "default"))))
     ...
     (c-annotation-face ((t (:foreground "#00ff00"))))
     ...
     (info-menu-5 ((t (:bold t :underline t :weight bold))))
     (info-menu-6 ((t (nil))))
     ...
     (mode-line-buffer-id ((t (:bold t :background "darkslateblue" :foreground "white" :box (:line-width 2 :style released-button) :weight bold))))
